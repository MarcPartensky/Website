...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{% static 'article/cache/style.css' %}" />
    <link rel="stylesheet" type="text/css" href="{% static 'article/cache/pilcrow.css' %}" />
    <link rel="stylesheet" type="text/css" href="{% static 'article/cache/hljs-solarized-light.min.css' %}" />
