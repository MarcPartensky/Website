class Motion extends Matrix {
  ...
  static random(width=Motion.width, height=Motion.height) {
    return Motion.from(Matrix.random(width, height));
  }
  ...
  show(ctx) {
    this.velocity.show(ctx, this.position, "blue");
    this.acceleration.show(ctx, this.position, "red");
  }
}
